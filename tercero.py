...
class TraductorCSSHTML:
    ...
    def analizar_linea(self, linea, variables):
        ...
        # Busca: [clave] = [valor] donde valor puede tener espacios, comas, paréntesis, etc.
    ...
    def vista_previa_html(self, archivo_cssx, titulo="Vista previa"):
        ...
        # print("Vista previa generada:", ruta_html)
...
if __name__ == "__main__":
    ...
    # Define el nombre del archivo .cssx que debes crear manualmente
    nombre_archivo_cssx_para_vista_previa = "mi_estilo.cssx" # <--- Asegúrate que este nombre coincide

    # Llama a vista_previa_html con el nombre del archivo
    try:
        traductor.vista_previa_html(nombre_archivo_cssx_para_vista_previa)
        print(f"Intentando abrir la vista previa de '{nombre_archivo_cssx_para_vista_previa}'...")
    except FileNotFoundError:
        print(f"ERROR: No se encontró el archivo '{nombre_archivo_cssx_para_vista_previa}'.")
        print("Por favor, crea un archivo llamado 'mi_estilo.cssx' (o el nombre que hayas puesto arriba) en la carpeta de tu notebook y pega el contenido CSSX dentro.")
    except Exception as e:
        print(f"Ocurrió un error al generar la vista previa: {e}")

    # Puedes seguir usando las traducciones directas si quieres ver la salida en la consola
    # Ejemplo de CSS para imprimir en consola (ya no se usa para vista previa directa)
    ejemplo_css_para_imprimir = '''
    ...
    print("\n=== TRADUCCIÓN CSS (ejemplo directo) ===")
    resultado_css = traductor.traducir_a_css(ejemplo_css_para_imprimir)
    print(resultado_css)

    #print("\n=== TRADUCCIÓN TML (ejemplo directo) ===")
    resultado_html = traductor.traducir_a_html(ejemplo_css_para_imprimir)
